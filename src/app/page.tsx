    ...
    <main className="min-h-screen bg-[#0a0a1a] text-white">
      ...
      >
        ...
        <span className="relative flex">
          ...
          <span className="relative inline-flex h-14 w-14 rounded-full bg-[#25D366] shadow-2xl shadow-[#25D366]/40 items-center justify-center ring-4 ring-[#0a0a1a] group-hover:scale-110 transition-transform">
